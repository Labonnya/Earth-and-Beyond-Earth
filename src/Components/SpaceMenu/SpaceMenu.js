...
const SpaceMenu = () => {
  ...
  return (
    <div className='space-menu-item'>
      <div className='row'>
        <button className='btn-space-menu' style={{ textShadow: '0 0 10px rgba(255, 255, 255, 0.8)', transition: 'color 0.3s', animation: 'glow 1s infinite alternate' }} onClick={scrollToConcept}>
      ...
      <div className='row concept'>
        ...
        <div className='col-6'>
            <h4 style={{ textShadow: '0 0 10px rgba(255, 255, 255, 0.8)', transition: 'color 0.3s', animation: 'glow 1s infinite alternate', marginTop: '120px' }}>Learn About Galaxies</h4>
            <br /><br /><br /><br />
