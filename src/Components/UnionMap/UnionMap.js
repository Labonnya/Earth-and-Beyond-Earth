...
const UnionMap = () => {
  ...
  const determineFillColorUnion = (geo) => {
    return fillColorMapAU[geo.properties.name] || fillColorMapASEAN[geo.properties.name] || fillColorMapAL[geo.properties.name] || fillColorMapEU[geo.properties.name] || fillColorMapSAARC[geo.properties.name] || fillColorMapEEU[geo.properties.name] ||"grey";
  };
